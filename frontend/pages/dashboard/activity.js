...
import { PageHeader, Card, StatusBadge, LoadingState } from '../../components/ui'
...
export default function ActivityPage() {
  ...
  if (loading) return <Layout title="Activity"><LoadingState /></Layout>

  return (
    <Layout title="Activity">
      <PageHeader title="Activity" description="Recent audit log entries" />
      <Card>
        {logs.length === 0 ? (
